...
QUICK_REFERENCE = {
    ...
    "server_updates": "Use reinstall_server + hard restart Claude Desktop after code changes",
    "finding_code": "Use find_in_file and find_files for navigation",
    "new_tools": "After adding tools: reinstall_server → hard restart Claude → new chat session"
}
